      ...
      <div class="card">
        <div class="card-body">
          <form action="" method="POST">
            <input type="hidden" name="id" id="id" value="<?= $priceDetail->id ?>">
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select name="type" id="workshopType" class="form-select <?= form_error('type') ? 'is-invalid' : ''; ?>">
                    ...
                    <option value="online" <?= ($priceDetail->type === 'online') ? 'selected' : '' ?>>Online</option>
                    <option value="offline" <?= ($priceDetail->type === 'offline') ? 'selected' : '' ?>>Offline</option>
                  </select>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="date" class="form-control <?= form_error('start_date') ? 'is-invalid' : ''; ?>" id="workshopStart" name="start_date" value="<?= set_value('start_date') ? set_value('start_date') : $priceDetail->start_date; ?>">
                  <div class="invalid-feedback">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="date" class="form-control <?= form_error('end_date') ? 'is-invalid' : ''; ?>" id="workshopEnd" name="end_date" value="<?= set_value('end_date') ? set_value('end_date') : $priceDetail->end_date; ?>">
                  <div class="invalid-feedback">
                    <?= form_error('end_date'); ?>
                  </div>
                </div>
